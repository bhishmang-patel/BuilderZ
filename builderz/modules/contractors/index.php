...
<div class="cont-wrap">
    ...
    <div class="stats-strip">
        ...
        <div class="stat-card">
            ...
            <div class="stat-value" style="color:var(--accent)"><?= formatCurrencyShort($stats['total_billed']) ?></div>
        </div>
        <div class="stat-card">
        ...
        <div class="stat-card">
            ...
            <div class="stat-value" style="color:#ea580c"><?= formatCurrencyShort($stats['total_pending']) ?></div>
        </div>
    </div>
