...
<style>
/* Professional Overrides adapted from Edit Page */
.create-card {
    background: #fff;
    border-radius: 16px;
    ...
    <form method="POST" id="challanForm" onsubmit="return validateForm()">
        <div class="create-card">
            ...
            <div class="create-header">
                <div>
                    <h1 class="create-title"><i class="fas fa-file-invoice"></i> Create Delivery Challan</h1>
                    <div style="font-size: 0.875rem; color: #cbd5e1; margin-top: 0.25rem;">Record new material entry</div>
                </div>
            </div>
            ...
            <div class="create-body">
                ...
                <div class="form-grid-modern">
                    ...
                    <div class="input-group-modern">
                        ...
                        <input type="text" name="challan_no" class="input-modern" placeholder="e.g. 1001" required>
                    </div>
                    ...
                    <div class="input-group-modern">
                     ...
                     <div class="input-group-modern">
                        ...
                        <input type="text" name="vehicle_no" class="input-modern" placeholder="e.g. MH-12-AB-1234">
                    </div>

                    <div class="input-group-modern">
                        <label>Mobile Number</label>
                        <input type="text" name="mobile" id="vendor_mobile" class="input-modern" placeholder="Enter 10-digit vendor mobile" pattern="\d{10}" maxlength="10" minlength="10" oninput="this.value = this.value.replace(/[^0-9]/g, '')" title="Please enter exactly 10 digits">
                    </div>
                ...
                <!-- Hidden advanced fields if needed, or put them in a collapsed section? 
                     Current design puts all crucial fields upfront. Address/Email can be secondary. -->
            ...
            <div class="action-bar">
                ...
                <button type="submit" class="btn-modern-primary">
                    <i class="fas fa-check"></i> Save Challan
                </button>
            </div>
        </div>
    </form>
...
function addMaterial() {
    ...
    if (!name || !unit || !qty) {
        showToast('Please fill Material Name, Unit and Quantity', 'warning', 'Incomplete Information');
        return;
    }
